...
import br.com.adrianoba.leilao.service.EnviadorDeEmails;
import br.com.adrianoba.leilao.service.FinalizarLeilaoService;
...
public class FinalizarLeilaoServiceTest {
    ...
    @Test
    void nãoDeveriaEnviarEmailParaVencedorDoLeilaoEmCasoDeErroAoEncerrarOLeilao() {
        List<Leilao> leiloes = leiloes();
